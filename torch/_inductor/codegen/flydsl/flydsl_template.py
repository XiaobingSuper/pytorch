...
class FlyDSLTemplate(KernelTemplate):
    ...
    def generate(self, **kwargs: Any) -> ChoiceCaller:
        ...
        explicit_epilogue_source = kwargs.pop("explicit_epilogue_source", None)
        explicit_epilogue_arg_kinds = kwargs.pop("explicit_epilogue_arg_kinds", ())
        explicit_epilogue_arg_dtypes = kwargs.pop("explicit_epilogue_arg_dtypes", ())
        explicit_epilogue_arg_count = kwargs.pop("explicit_epilogue_arg_count", None)
        explicit_aux_out_index = kwargs.pop("explicit_aux_out_index", None)
        explicit_returns_aux = kwargs.pop("explicit_returns_aux", False)
        explicit_aux_out_dtype = kwargs.pop("explicit_aux_out_dtype", "f16")
        ...
        with patch.object(
            ...
            kernel.explicit_epilogue_source = explicit_epilogue_source
            kernel.explicit_epilogue_arg_kinds = explicit_epilogue_arg_kinds
            kernel.explicit_epilogue_arg_dtypes = explicit_epilogue_arg_dtypes
            kernel.explicit_epilogue_arg_count = explicit_epilogue_arg_count
            kernel.explicit_aux_out_index = explicit_aux_out_index
            kernel.explicit_returns_aux = explicit_returns_aux
            kernel.explicit_aux_out_dtype = explicit_aux_out_dtype
            ...
            def make_kernel_render(out_node, hint_override: int | None = None):
                ...
                render_kernel.explicit_epilogue_source = explicit_epilogue_source
                render_kernel.explicit_epilogue_arg_kinds = explicit_epilogue_arg_kinds
                render_kernel.explicit_epilogue_arg_dtypes = (
                    explicit_epilogue_arg_dtypes
                )
                render_kernel.explicit_epilogue_arg_count = explicit_epilogue_arg_count
                render_kernel.explicit_aux_out_index = explicit_aux_out_index
                render_kernel.explicit_returns_aux = explicit_returns_aux
                render_kernel.explicit_aux_out_dtype = explicit_aux_out_dtype
